...
GATEWAY_MODE = os.getenv("SENSOR_GATEWAY_MODE", "simulation").strip().lower() or "simulation"
SIMULATE_SENSOR_DATA = os.getenv("SIMULATE_SENSOR_DATA", "1").strip().lower() in {"1", "true", "yes", "on"}
ENABLE_VIDEO_STREAM = os.getenv("ENABLE_VIDEO_STREAM", "0").strip().lower() in {"1", "true", "yes", "on"}
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=int(os.getenv("PORT", "18080")))
