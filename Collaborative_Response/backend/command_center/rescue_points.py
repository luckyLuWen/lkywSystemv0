...
def _agent_poi_seed() -> list[tuple]:
    ...
    return [
        ...
        # 医疗急救
        ("leak", "medical", "团风县人民医院",           30.6472, 114.8705),
        ("leak", "medical", "淋山河镇中心卫生院",       30.6750, 114.8450),
        ("leak", "medical", "马曹庙镇卫生院",           30.6550, 114.9350),
        # 消防灭火
        ("leak", "fire",    "团风县公安消防大队",       30.6435, 114.8732),
        ("leak", "fire",    "江北工业园专职消防队",     30.6080, 114.8805),
        ("leak", "fire",    "回龙山镇消防备勤点",       30.6250, 114.9450),
        # 公安交警
        ("leak", "police",  "团风县公安局交警大队",     30.6395, 114.8690),
        ("leak", "police",  "方高坪镇派出所",           30.6850, 114.8850),
        ("leak", "police",  "总路咀镇交警中队",         30.6100, 114.9200),
        # 防化部队
        ("leak", "hazmat",  "团风县消防特勤防化站",     30.6510, 114.8650),
        ("leak", "hazmat",  "黄州区防化增援大队",       30.5850, 114.8850),
        ("leak", "hazmat",  "团风港区危化应急站",       30.6350, 114.8450),
        # 交通路政
        ("leak", "road",    "团风县路政管理大队",       30.6420, 114.8785),
        ("leak", "road",    "上巴河镇道班",             30.6650, 114.9450),
        ("leak", "road",    "大桥收费站管理处",         30.6250, 114.8350),
