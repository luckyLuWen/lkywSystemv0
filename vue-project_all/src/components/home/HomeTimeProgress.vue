...
const TRUCK_PHASE_DESC = [
  { shortLabel: '仿真推演开始', time: '14:00', description: '系统完成数字孪生场景初始化，基于随岳（随州-岳阳）高速仙桃市毛嘴镇珠玑村路段真实事故原型展开全过程推演。' },
  { shortLabel: '车辆正常行驶', time: '14:05', description: '2011年7月4日凌晨3时50分至4时许，大型旅游客车（鄂AE3892，载52人含5名儿童）正常行驶于随岳高速仙桃段。' },
  { shortLabel: '事故发生', time: '14:12', description: '后方大型货车（鄂FEA30挂）满载冬瓜以超限速度跟驰，疲劳驾驶状态下未保持安全车距。车载边缘网关实时采集两车速度、位置与行驶姿态数据。' },
