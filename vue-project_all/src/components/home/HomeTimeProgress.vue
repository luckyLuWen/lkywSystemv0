...
const TRUCK_PHASE_DESC = [
  ...
  { shortLabel: '事故发生', time: '14:12', description: '后车未保持安全距离，检测到两客一危车辆发生碰撞，事故现场暂时无火，通知无人机准备进行侦查。' },
...
const TANKER_PHASE_DESC = [
  ...
  { shortLabel: '无人感知执行', time: '15:50', description: '无人机与无人车到达指定点，基站发出提供信号，设备接受信号并形成组网，同时无人机，无人车，固定监控，基站构成一个传感网原型。信号干扰：现场环境复杂，收到信号干扰导致基站不能正常发射信号，此时网络路由需要改变：基站发出信号—>无人车jetson搭载信号发送与接收作为移动基站。' },
  { shortLabel: '信号干扰', time: '15:55', description: '现场电磁环境复杂，通信信号受到干扰，数据传输出现断续。系统启动抗干扰机制，切换备用通信链路。' },
  { shortLabel: '救援装备出动', time: '16:00', description: '触发多智能体并发决策，基于真实 OSM 拓扑路网运行 Dijkstra 加权寻优算法，动态剔除路网阻断与远距绕行节点，精确定位并联动五类救援站点（消防、医疗、公安、防化、路政）协同出动。' },
]
