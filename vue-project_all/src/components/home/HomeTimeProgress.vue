...
const TRUCK_PHASE_DESC = [
  { shortLabel: '仿真推演开始', time: '14:00', description: '系统完成数字孪生场景初始化，基于随岳（随州-岳阳）高速仙桃市毛嘴镇珠玑村路段真实事故原型（鄂AE3892客车与鄂FEA30挂货车追尾）展开全过程推演。' },
  ...
  { shortLabel: '信号干扰', time: '14:45', description: '现场复杂电磁环境导致基站通信受到强干扰。系统自动启动抗干扰机制，由搭载 Jetson 算力板的无人车切换为移动基站自组网路由。' },
...
const TANKER_PHASE_DESC = [
  ...
  { shortLabel: '信号干扰', time: '15:55', description: '现场复杂环境导致基站通信出现强干扰。系统自动启动路由自愈机制，由搭载 Jetson 模块的无人车接管并担任移动基站继续组网。' },
