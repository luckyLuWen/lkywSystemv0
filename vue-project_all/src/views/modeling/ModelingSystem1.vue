<!--
================================================================================
  精细三维建模系统 1 (ModelingSystem1.vue)
  【独立模块说明】
  本组件为“精细三维建模系统 1”（第一代三维模型检测系统）。
  完全独立自包含，不与系统 2 产生任何代码耦合。
  
  【下线/删除指引】
  若后续需要彻底下线/删除精细系统 1：
  1. 直接物理删除本文件 (ModelingSystem1.vue)；
  2. 在 src/views/ModelingView.vue 中移除对 ModelingSystem1 的引入和切换Tab即可。
================================================================================
-->
<template>
  <div class="modeling-system-1">
    <!-- Top Header Bar -->
      ...
      <div class="header-left">
        ...
        <div class="header-title-group">
          <div class="title-with-badge">
            <h1>精细三维建模系统 1</h1>
            <span class="system-badge">系统 1 (基础版)</span>
          </div>
          <span class="sub-title">Fine-grained 3D Modeling Inspector v1.0</span>
        </div>
      </div>
...
const freezeLastFrame = () => {
  ...
  const tryFreeze = () => {
    if (modelViewer.duration > 0) {
      ...
      console.log('[ModelViewer System 1] Successfully frozen at last frame:', modelViewer.duration, 's')
